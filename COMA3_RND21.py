...
class COMA(object):
    ...
    def train(self, o1_list, a1_list, pi_a1_list, o2_list, a2_list, pi_a2_list, r_list,adv1_int,adv2_int,pred_s_list,pred_s_dat_list,adv_sur_int,clip_ratio):
...
def game(mode, clip_ratio):
    ...
    for epi_iter in range(max_epi_iter):
        ...
        print("####################################")
        agent.train(o1_list, a1_list, pi_a1_list, o2_list, a2_list, pi_a2_list, r_list,adv1_int,adv2_int,pred_s_list,pred_s_dat_list,adv_sur_int, clip_ratio)
...
if __name__ == '__main__':
    loop = 5
    #plot= {}
    modes = [('intrinsic',3),('intrinsic',5),('intrinsic',0.5),('intrinsic',1),('intrinsic',2),('normal',0)]
    ...
    for (mode, clip_ratio) in modes:
        ...
        for i in range(loop):
            ...
            if mode =='intrinsic'and clip_ratio == 3:
                color = 'r'
            elif mode =='intrinsic'and clip_ratio == 5:
                color = 'c'
    ...
    plot_sum("MARL_RND_COMA_3.0_clip_ratio",collect_data_temp_avg_int_ma_0_1,collect_data_temp_std_int_ma_0_1,color)
    plot_sum("MARL_RND_COMA_5.0_clip_ratio",collect_data_temp_avg_int_ma_0_2,collect_data_temp_std_int_ma_0_2,color)
