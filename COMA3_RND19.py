...
class COMA(object):
    ...
    def train(self, o1_list, a1_list, pi_a1_list, o2_list, a2_list, pi_a2_list, r_list,adv1_int,adv2_int,pred_s_list,pred_s_dat_list,adv_sur_int,clip_ratio):
        ...
        for t in range(T - 1):
            ...
            #print("a_index",Q_est.shape)
            #print("000",self.cross_prod(pi_a1_list[t+1], pi_a2_list[t+1] ))
            #print("Q_est[t][a_index] = ",Q_est.shape)
...
if __name__ == '__main__':
    loop = 1
    #plot= {}
    modes = [('intrinsic',0.1),('intrinsic',0.2),('intrinsic',0.5),('intrinsic',1),('normal',0)]
    ...
    for (mode, clip_ratio) in modes:
        ...
        for i in range(loop):
            ...
            if mode =='intrinsic'and clip_ratio == 0.1:
                color = 'r'
            elif mode =='intrinsic'and clip_ratio == 0.2:
                color = 'c'
    ...
    for i in range (len(train_curve_avg_int)):
        if (i >= 100): 
            ...
            collect_data_temp_avg_int_ma.append(temp_avg_int_ma2)
            temp_std_int_ma2 = np.mean(train_curve_std_int2[i-100:i])
            collect_data_temp_std_int_ma.append(temp_std_int_ma2)
    ...
    for i in range (len(train_curve_avg_int)):
        if (i >= 100): 
            ...
            collect_data_temp_avg_int_ma.append(temp_avg_int_ma_1)
            temp_std_int_ma_1 = np.mean(train_curve_std_int_1[i-100:i])
            collect_data_temp_std_int_ma.append(temp_avg_int_ma_1)
    ...
    for i in range (len(train_curve_avg_int)):
        if (i >= 100): 
            ...
            collect_data_temp_avg_int_ma.append(temp_avg_int_ma5)
            temp_std_int_ma5 = np.mean(train_curve_std_int5[i-100:i])
            collect_data_temp_std_int_ma.append(temp_std_int_ma5)
    ...
    for i in range (loop):
        collect_data_temp_norm.append(mode_data[modes[4][0]+"_"+str(modes[4][1])][i])
    ...
    plot_sum("MARL_RND_COMA_0.1_clip_ratio",collect_data_temp_avg_int_ma_0_1,collect_data_temp_std_int_ma_0_1,color)
    plot_sum("MARL_RND_COMA_0.2_clip_ratio",collect_data_temp_avg_int_ma_0_2,collect_data_temp_std_int_ma_0_2,color)
