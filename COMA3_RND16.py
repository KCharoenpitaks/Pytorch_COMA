...
class COMA(object):
    ...
    def train(self, o1_list, a1_list, pi_a1_list, o2_list, a2_list, pi_a2_list, r_list,adv1_int,adv2_int,pred_s_list,pred_s_dat_list,adv_sur_int):
        ...
        for t in range(T):
            ...
            adv1_int_scaled = np.clip(adv1_int[t][0],-A1_list[t].item(),A1_list[t].item())*1#/(np.power(10,magnitude(adv1_int[t]*10)-magnitude(A1_list[t])))
        ...
        for t in range(T):
            ...
            adv2_int_scaled =  np.clip(adv2_int[t][0],-A1_list[t].item(),A1_list[t].item())*1#/(np.power(10,magnitude(adv2_int[t]*10)-magnitude(A2_list[t])))
