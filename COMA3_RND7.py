...
def plot(train_curve, i, mode,color): #def plot(name,time, Average_win,color):
    plt.figure('Average reward of '+ str(mode) + ' for ' + str(i) + ' round')
    plt.plot(train_curve,color)
    plt.xlabel('Episode')
    plt.ylabel('Rewards of '+ str(modes) + ' for ' + str(i) + ' round')
...
if __name__ == '__main__':
    ...
    for i in range(loop):
        for mode in modes:
            ...
            round_data.append(mode_data.append(train_curve))
