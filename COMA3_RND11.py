...
class COMA(object):
    ...
    def train(self, o1_list, a1_list, pi_a1_list, o2_list, a2_list, pi_a2_list, r_list,adv1_int,adv2_int,pred_s_list,pred_s_dat_list,adv_sur_int):
        ...
        for t in range(T):
            ...
            a1_loss = a1_loss + (A1_list[t].item()+adv1_int[t][0]+adv_sur_int[t][0])* torch.log(pi_a1_list[t][0, a1_list[t]])
        a1_loss = -a1_loss / T 
        ...
        for t in range(T):
            a2_loss = a2_loss + (A2_list[t].item()+adv2_int[t][0]+adv_sur_int[t][0]) * torch.log(pi_a2_list[t][0, a2_list[t]])
        a2_loss = -a2_loss / T 
