...
def get_intrinsic_rewards4(AI,states,actions,agents,n_agents,episode_reward,timesteps,multiple,discount):
    ...
    if (AI == "COMA") or (AI == "CAC") or (AI == "COMA2"):
        ...
        for agent_id in range(n_agents):
            ...
            rewards_intrinsic = 1*np.power(discount,timesteps)*multiple*np.log(episode_reward)
            #print(np.log(2))
   # print("rewards_intrinsic=",rewards_intrinsic)
    return rewards_intrinsic
    ...
    for i_episode in range(1, max_episodes+1):
        ...
        #while not done:
            ...
            if ((AI_type == "PPO"or AI_type == "A2C") and Intrinsic_type == "1"):
                ...
                intrinsic_rewards = get_intrinsic_rewards4(AI_type,state,action,ppo,n_agents,reward*10,t,100,0.99) 
...
def main():
    ...
    for AI in AI1:
        ...
        plot("FrozenLake",avg_reward, best_avg_reward,samp_rewards, AI,'b')
        avg_reward, best_avg_reward,samp_rewards,stats = game(N_episodes, AI, "1",0.1) 
        plot("FrozenLake",avg_reward, best_avg_reward,samp_rewards, AI,'g')
        avg_reward, best_avg_reward,samp_rewards,stats = game(N_episodes, AI, "1",0.2) 
        plot("FrozenLake",avg_reward, best_avg_reward,samp_rewards, AI,'r')
        avg_reward, best_avg_reward,samp_rewards,stats = game(N_episodes, AI, "1",0.5) 
        plot("FrozenLake",avg_reward, best_avg_reward,samp_rewards, AI,'y')
        avg_reward, best_avg_reward,samp_rewards,stats = game(N_episodes, AI, "1",1) 
        plot("FrozenLake",avg_reward, best_avg_reward,samp_rewards, AI,'m')
        ...
        plot("FrozenLake",avg_reward, best_avg_reward,samp_rewards, AI,'c')
